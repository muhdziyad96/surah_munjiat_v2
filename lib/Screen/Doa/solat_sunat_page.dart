...
class SolatSunatPage extends StatefulWidget {
  final String title, path, subText;
  const SolatSunatPage(
      {super.key,
      required this.title,
      required this.path,
  ...
  @override
  State<SolatSunatPage> createState() => _SolatSunatPageState();
}

class _SolatSunatPageState extends State<SolatSunatPage> {
  @override
